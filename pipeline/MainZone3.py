...
#
RESPATH = r'/home/md_vandamme/4_RESEAU/Ex2Z3Walk/'
...
# traces de la zone 3 (km x km)
X = [954421, 954559, 954765, 954867, 954443, 954273, 954421]
Y = [6516239, 6516179, 6516182, 6516958, 6516955, 6516647, 6516239]
...
if STAGE == 5:
    t0 = time.time()
    second_round(RESPATH, NB_OBS_MIN, G1_SIZE, G2_SIZE, DIST_MIN_ARC)
    t1 = time.time()
    total = t1-t0
    print ("Temps d'exécution en s:", total)
