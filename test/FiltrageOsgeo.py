...
# Output: géométrie filtrée avec suppression de toutes les longueurs
#         d'onde comprises entre r/f et r*f
# -----------------------------------------------------------------------------
...
# road_surface_PT
dsRoadSurface = ogr.Open("/home/md_vandamme/4_RESEAU/Ex2Z1Walk/image/clean.shp", 0)
layerRoadSurface = dsRoadSurface.GetLayer()
print(ogr.GetDriverCount())
